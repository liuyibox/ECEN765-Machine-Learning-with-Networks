...
#for each label out of 10 labels, we compute the accuracy separately
    ...
    for sample_index in range(label_counts[i]):
        train_sample_prob_array_50 = []
        train_sample_prob_array_100 = []
        train_sample_prob_array_150 = []
        for k in range(10):                     #k=label_index
            ...
            for j in range(150):
                ...
                if(j < 100):
                    if label_transformed_data_100[j,sample_index] == 1:
                    ...
                    if(j < 50):
                        if label_transformed_data_50[j,sample_index] == 1:
                ...
                if label_transformed_data_150[j,sample_index] == 1:
            ...
            target_class_prob = label_counts[i] / (float(total_train_sample))                   #training sample label probability
            ...
            train_sample_prob_array_50.append(target_class_predict_prob_50)
            train_sample_prob_array_100.append(target_class_predict_prob_100)
            train_sample_prob_array_150.append(target_class_predict_prob_150)

        max_prob_index_50 = train_sample_prob_array_50.index(max(train_sample_prob_array_50))
        max_prob_index_100 = train_sample_prob_array_100.index(max(train_sample_prob_array_100))
        max_prob_index_150 = train_sample_prob_array_150.index(max(train_sample_prob_array_150))
        ...
        if max_prob_index_100 == i:
            ...
            total_accuracy_100 += 1
        if max_prob_index_150 == i:
            label_accuracy_150 += 1
            total_accuracy_150 += 1

    label_accuracy_array_50.append(label_accuracy_50)
    label_accuracy_array_100.append(label_accuracy_100)
    label_accuracy_array_150.append(label_accuracy_150)

print "PCA to 50 dimensions: train accuracy = ", total_accuracy_50
print "PCA to 100 dimensions: train accuracy = ", total_accuracy_100
print "PCA to 150 dimensions: train accuracy = ", total_accuracy_150